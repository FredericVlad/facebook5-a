...
<div class="container">
    ...
    <a href="/facebook5-a/app/views/persona/create.php"><button>Agregar</button></a>
            ...
            <?php if (!empty($personas) && is_array($personas)): ?>
                <?php foreach ($personas as $persona): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($persona['sexo']); ?></td> <td><?php echo htmlspecialchars($persona['estadocivil']); ?></td> <td>
                            <a href="/facebook5-a/public/persona/editForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/facebook5-a/public/persona/deleteForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>"
